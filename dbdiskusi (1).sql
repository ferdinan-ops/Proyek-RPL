...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3470642780ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tabel terakhir" class="drop_button btn">Terbaru</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbdiskusi&table=user">`dbdiskusi`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbdiskusi&table=file">`dbdiskusi`.`file`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbdiskusi&table=file_komen">`dbdiskusi`.`file_komen`</a></li></ul></div><div class="drop_list"><button title="Tabel favorit" class="drop_button btn">Favorit</button><ul id="pma_favorite_list"><li class="warp_link">Tidak ada tabel favorit terbaru.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2934757c27487e7b706d2a64215c5f31">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="dbdiskusi" targettable="">
            ...
            Waktu eksekusi kueri
                            ...
                            targetdb="dbdiskusi" targettable="user">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="dbdiskusi" targettable="file">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">CREATE TABLE `dbdiskusi`.`file` ( `id` INT NOT NULL AUTO_INCREMENT ,  `nama` INT NOT NULL ,  `lokasi` INT NOT NULL ,  `id_berita` INT NOT NULL ,    PRIMARY KEY  (`id`),    INDEX  (`id_berita`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="dbdiskusi" targettable="file_komen">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">CREATE TABLE `dbdiskusi`.`file_komen` ( `id` INT NOT NULL AUTO_INCREMENT ,  `nama` VARCHAR(255) NOT NULL ,  `lokasi` VARCHAR(255) NOT NULL ,  `id_komentar` INT NOT NULL ,    PRIMARY KEY  (`id`),    INDEX  (`id_komentar`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dbdiskusi" targettable="file">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `file`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dbdiskusi" targettable="user">
                            <div class="action_content">
